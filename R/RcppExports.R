...
calc_mu_log <- function(x, beta, offset) {
    .Call(`_sprintr_calc_mu_log`, x, beta, offset)
}

logistic <- function(x, y, offset) {
    .Call(`_sprintr_logistic`, x, y, offset)
}

calc_mu_pois <- function(x, beta, offset) {
    .Call(`_sprintr_calc_mu_pois`, x, beta, offset)
}

poisson <- function(x, y, offset) {
    .Call(`_sprintr_poisson`, x, y, offset)
}

calc_mu_multi <- function(x, beta, offset) {
    .Call(`_sprintr_calc_mu_multi`, x, beta, offset)
}

multi <- function(x, y, offset, K) {
    .Call(`_sprintr_multi`, x, y, offset, K)
}

calc_delta_ordinal <- function(etaMat) {
    .Call(`_sprintr_calc_delta_ordinal`, etaMat)
}

calc_eta_ordinal <- function(delta) {
    .Call(`_sprintr_calc_eta_ordinal`, delta)
}

tran_xspan <- function(x, K) {
    .Call(`_sprintr_tran_xspan`, x, K)
}

tran_yspan <- function(y, n, K) {
    .Call(`_sprintr_tran_yspan`, y, n, K)
}

ordinal <- function(x, y, offset, n, K) {
    .Call(`_sprintr_ordinal`, x, y, offset, n, K)
}

ordinal_sparse <- function(x, y, yMat, offset, n, K) {
    .Call(`_sprintr_ordinal_sparse`, x, y, yMat, offset, n, K)
}
...
screen_cpp <- function(x, y, nlev, offset, num_keep, square = FALSE, main_effect = FALSE, family = "gaussian") {
    .Call(`_sprintr_screen_cpp`, x, y, nlev, offset, num_keep, square, main_effect, family)
}
...
screen_sparse_cpp <- function(x, y, yMat, nlev, offset, num_keep, square = FALSE, main_effect = FALSE, family = "gaussian") {
    .Call(`_sprintr_screen_sparse_cpp`, x, y, yMat, nlev, offset, num_keep, square, main_effect, family)
}

logistic_MMLE <- function(x, y, offset) {
    .Call(`_sprintr_logistic_MMLE`, x, y, offset)
}
...
#' @export
screen_cpp_MMLE_binomial <- function(x, y, offset, num_keep, square = FALSE, main_effect = FALSE) {
    .Call(`_sprintr_screen_cpp_MMLE_binomial`, x, y, offset, num_keep, square, main_effect)
}
